...
const AskAiScreen = () => {
  ...
  return (
    <SafeAreaView className="flex-1 px-6 pt-8 pb-6">
      ...
      >
        <View className="bg-black-100/30 py-2 px-4 rounded-full flex-row items-center justify-between">
          <TextInput
          ...
          <CustomButton
            ...
            iconSize="size-6"
            btnClassname="bg-primary-100/80 size-10 items-center justify-center rounded-full"
